...
class Utilisateur {
    ...
    /** @var array tableau<Type> : liste des Types "aimés" par l'utilisateur */
    private array $lesTypesAimes;
     ...
     * @return array
     */
    public function getLesTypesAimes(): array
    {
        return $this->lesTypesAimes;
    }

    /**
     * @param array $lesTypesAimes
     */
    public function setLesTypesAimes(array $lesTypesAimes): void
    {
        $this->lesTypesAimes = $lesTypesAimes;
    }
