...
foreach ($listeRestos as $unResto) {
    ...
    <?= $unResto->getVilleR() ?>
            ...
            <span style="color: #C2289F">#</span><?= implode(" <span style='color: #C2289F'>#</span>",$unResto->getLesTypes()) ?>
...
Classement basé sur les critiques de nos utilisateurs. </br>

Site développé par MNAUD, NFRANCODASILVA, MBERREZ.
